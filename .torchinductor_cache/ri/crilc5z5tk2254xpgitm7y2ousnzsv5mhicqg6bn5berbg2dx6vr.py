...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\ag\cagym3vyqwxlco3lkaj4vfj77htwxc7wwx5b3h25iri7rr6akpiy.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\bm\cbmvfz545jhjacv2hiiujuzdwjsc4cn6qgkwtlwmsxg7wntdv2ny.py
# Topologically Sorted Source Nodes: [patch_h], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\vv\cvvdupo7x2bep7vlwx66hc53h4iun62vsksaiigmv6gzolfdmdra.py
# Topologically Sorted Source Nodes: [patch_h], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\jd\cjdsnaat2homdpxr7d5ytxlxoazm2kse5ja3pahww2n5pk7oiw2d.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\4z\c4z3byaodk2dvh6zuztapgwg7z4smyqkhjk35nrfflvpdpzslvl6.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\ar\cariq7z6yluu66dv2axdzxucqxiwtbctpytm5ho4mf3b56xx43kg.py
...
def triton_per_fused__to_copy_add_native_layer_norm_5(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    x0 = (xindex % 33)
    x1 = xindex // 33
    tmp0 = tl.load(in_ptr0 + (r0_2 + 168*x3), r0_mask & xmask, other=0.0).to(tl.float32)
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\qg\cqgn2ckyl4tpoxwctelfrjhmna64fcrgqsr74o5sbknqaohevbc3.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\ze\czeqg7cgdyl2e5jq44s7okzunyhnyuojgtddcruhbgsfm6hhcynp.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\eb\cebkskvvywv4w32vn7hmv77bygtckdsupwg6kcqrlpevuqac22kz.py
# Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\2j\c2j5vyz2fwadt7ddfa3s2nm32aw4wb4mskrqntnozqwfbl5bjwnq.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\e5\ce5okbrl46lvmfgssdcbidpwtskczogneoeoyoaz2prznwbyyhle.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\y5\cy5jto4zpmq5phflwrb6gr4pjahl2csgarvf3rkcbpbmeldebxxl.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\tb\ctbrs3ywazk2dntamydal7taf3mdmxfqgxn3jtpkcjifwcot3kii.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\n6\cn6w3juz2opnwz4amfyaawpb55rdmxmxfezlaa4ys4oyc6eoirwu.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\kg\ckgwo67ifajzywaswf7kblw4gbsm7vxutcvflp5abpjvnqmrholp.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\hp\chpbuygfzvzv5aahyejlrwxbpn7tpcqalyonl2z6h2vrul6nh5d4.py
...
def triton_per_fused__safe_softmax_add_scalar_tensor_where_15(in_out_ptr0, in_ptr0, in_ptr1, out_ptr0, out_ptr1, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    x0 = (xindex % 33)
    x1 = xindex // 33
    tmp0 = tl.load(in_ptr0 + (r0_2 + 33*x3), r0_mask & xmask, other=0.0)
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\3p\c3psaqjgxxbkbaufrjit2xkvsp454gem7szkgy67c66h2rs7jskt.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\lw\clwwtobaaskbry5sjx7kogwkgk7vatfic3ob6kq55dqak4vzfrf3.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\iq\ciq2fu7d4v64secm3gtf5aqyzoeoptvx6cmt3p5am445qr6xqjoa.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\tv\ctvm7vp757pw6imgcjioattfaglgmthivyzw4lx2dx2ajgl3uf2i.py
...
def triton_per_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_19(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, out_ptr4, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp0 = tl.load(in_ptr0 + (r0_2 + 168*x3), r0_mask & xmask, other=0.0).to(tl.float32)
    tmp2 = tl.load(in_ptr1 + (r0_2 + 168*x0), xmask & r0_mask, eviction_policy='evict_last', other=0.0)
    tmp4 = tl.load(in_ptr2 + (r0_2 + 168*x3), r0_mask & xmask, other=0.0).to(tl.float32)
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\my\cmyc5qmyi5smbzvuormnsqrwqvb2qhgiypwqdwjj2xhdyycyf6mw.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\op\copinuy7tcoz6kdkl4scgwuvaebhvh3ljmpaowrgcytqzeflfkh5.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\cf\ccfln7xyxtynofkzeabvkk7cn3vpldsog7kitwa3d4irghwervm3.py
...
def triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_22(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr3, out_ptr4, out_ptr5, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_2 = r0_index
        tmp0 = tl.load(in_ptr0 + (r0_2 + 168*x3), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp2 = tl.load(in_ptr1 + (r0_2 + 168*x0), xmask & r0_mask, eviction_policy='evict_last', other=0.0)
        tmp4 = tl.load(in_ptr2 + (r0_2 + 168*x3), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp5 = tl.load(in_ptr3 + (r0_2), r0_mask, eviction_policy='evict_last', other=0.0)
        tmp10 = tl.load(in_ptr4 + (r0_2 + 168*x3), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp1 = tmp0.to(tl.float32)
        tmp3 = tmp1 + tmp2
        tmp6 = tmp5.to(tl.float32)
        tmp7 = tmp4 + tmp6
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\sq\csq3ytrifiv2dceq4kiw7cqh4smliiuay3gqmf3dhbbfdvvfldjv.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\ot\cot5mlkiggkmg4np7hkqzkaqconebh6od4hlhaffjrwgwvblmn6n.py
...
def triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_24(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, out_ptr4, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp1 = tl.load(in_ptr1 + (r0_2 + 168*x3), r0_mask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp15 = tl.load(in_ptr1 + (r0_2 + 168*x3), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\4q\c4qxoeo6djrq4wppwyx6lpmy47xtmoxvjujcvljkakdtzxdl6pop.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\u6\cu6hrt6bunvestg6bodlhzxk6dm42if5v5tf4fjldl725b5sd24r.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\zu\czuci32fjpvr3juvebrrrb7eh3ek6f7jk4rl73tqgyvfk42bc4dr.py
# Topologically Sorted Source Nodes: [input_1], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\zq\czqzhrv6ttbrcfungbbvpqfe3xfrfszen2ojpxjv2chiiwzads7s.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\kj\ckjudg6rpro4iozv7aqdxp7fiuzvkbut7aaa6u7vsktbp3idu4qn.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache\6e\c6eexeqw65l6u7mqol7j77xme2oi2zalrk7sgdfgltgnlxo4w4if.py
