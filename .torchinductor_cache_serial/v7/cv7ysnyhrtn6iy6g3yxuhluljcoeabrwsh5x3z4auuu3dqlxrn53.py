...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\ag\cagym3vyqwxlco3lkaj4vfj77htwxc7wwx5b3h25iri7rr6akpiy.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\bm\cbmvfz545jhjacv2hiiujuzdwjsc4cn6qgkwtlwmsxg7wntdv2ny.py
# Topologically Sorted Source Nodes: [patch_h], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\vv\cvvdupo7x2bep7vlwx66hc53h4iun62vsksaiigmv6gzolfdmdra.py
# Topologically Sorted Source Nodes: [patch_h], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\jd\cjdsnaat2homdpxr7d5ytxlxoazm2kse5ja3pahww2n5pk7oiw2d.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\4z\c4z3byaodk2dvh6zuztapgwg7z4smyqkhjk35nrfflvpdpzslvl6.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\4p\c4pk4lb5pqgzex4ba5rijec4rpewfo3sr6mcmrlvxd633lsavokm.py
...
def triton_per_fused__to_copy_add_native_layer_norm_5(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr1 + (r0_2 + 168*x0), r0_mask & xmask, eviction_policy='evict_last', other=0.0)
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\qg\cqgn2ckyl4tpoxwctelfrjhmna64fcrgqsr74o5sbknqaohevbc3.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\ze\czeqg7cgdyl2e5jq44s7okzunyhnyuojgtddcruhbgsfm6hhcynp.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\eb\cebkskvvywv4w32vn7hmv77bygtckdsupwg6kcqrlpevuqac22kz.py
# Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\2j\c2j5vyz2fwadt7ddfa3s2nm32aw4wb4mskrqntnozqwfbl5bjwnq.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\al\cal23qgdwi6ftugno2nxusrqlwjmhsgsekghwzfrt5abk3kad2ix.py
...
def triton_poi_fused__to_copy_add_mean_pow_rsqrt_10(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x2 + 33*y3), tmp5, xmask & ymask)
''', device_str='cuda')


# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\y5\cy5jto4zpmq5phflwrb6gr4pjahl2csgarvf3rkcbpbmeldebxxl.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\tb\ctbrs3ywazk2dntamydal7taf3mdmxfqgxn3jtpkcjifwcot3kii.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\n6\cn6w3juz2opnwz4amfyaawpb55rdmxmxfezlaa4ys4oyc6eoirwu.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\kg\ckgwo67ifajzywaswf7kblw4gbsm7vxutcvflp5abpjvnqmrholp.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\qo\cqos2cyz277ycdlystoelxvbwanjtbvutgf2tcf475flhy3mbtzt.py
...
def triton_per_fused__safe_softmax_add_scalar_tensor_where_15(in_out_ptr0, in_ptr0, in_ptr1, out_ptr0, out_ptr1, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (r0_2 + 33*x0), r0_mask & xmask, eviction_policy='evict_last', other=0.0).to(tl.int1)
    tmp2 = 0.0
    tmp3 = float("-inf")
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\3p\c3psaqjgxxbkbaufrjit2xkvsp454gem7szkgy67c66h2rs7jskt.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\lw\clwwtobaaskbry5sjx7kogwkgk7vatfic3ob6kq55dqak4vzfrf3.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\iq\ciq2fu7d4v64secm3gtf5aqyzoeoptvx6cmt3p5am445qr6xqjoa.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\bs\cbsljwcokizzplircfldvtlnbok2l3cvlo2w6me5ya2d2aan4sct.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\my\cmyc5qmyi5smbzvuormnsqrwqvb2qhgiypwqdwjj2xhdyycyf6mw.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\op\copinuy7tcoz6kdkl4scgwuvaebhvh3ljmpaowrgcytqzeflfkh5.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\qr\cqrpqfzzdkrl6wf3l2ubersofhmea3o6axpiyk2dl5cf5ijgoqvh.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\62\c62nalclzgwx4e7de5ibozbusr5742wx6daptcp73wjgcevedutz.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\jo\cjoggaanzuuroniwpgg5n6xkmiiayiofpq6bvrnvsxtdbw2rw4nz.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\4q\c4qxoeo6djrq4wppwyx6lpmy47xtmoxvjujcvljkakdtzxdl6pop.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\u6\cu6hrt6bunvestg6bodlhzxk6dm42if5v5tf4fjldl725b5sd24r.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\zu\czuci32fjpvr3juvebrrrb7eh3ek6f7jk4rl73tqgyvfk42bc4dr.py
# Topologically Sorted Source Nodes: [input_1], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\zq\czqzhrv6ttbrcfungbbvpqfe3xfrfszen2ojpxjv2chiiwzads7s.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\kj\ckjudg6rpro4iozv7aqdxp7fiuzvkbut7aaa6u7vsktbp3idu4qn.py
...
# kernel path: C:\Python310\layercake_merged_nextgen_perfectA_option1_full_ready\layercake_release\.torchinductor_cache_serial\6e\c6eexeqw65l6u7mqol7j77xme2oi2zalrk7sgdfgltgnlxo4w4if.py
